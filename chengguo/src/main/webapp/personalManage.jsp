...
<head>
    ...
    <script>
        function deleteUser(id){
            ...
            if(confirm("您确定要拒绝吗？")){
                //访问路径
                location.href="${pageContext.request.contextPath}/demand/refuseOne?id="+id;
            }
        }
        ...
        function passUser(id){
            ...
            if(confirm("您确定要通过吗？")){
                //访问路径
                location.href="${pageContext.request.contextPath}/demand/passOne?id="+id;
            }
        }
...
<%--    </div>--%>
    ...
    <form id="form" action="" method="post">
        ...
        <table border="1" class="table table-bordered table-hover">
            ...
            <c:forEach items="${personalDemands}" var="demand" varStatus="s">
                <tr>
...
<%--&lt;%&ndash;                 s       <a class="btn btn-default btn-sm" href="submit.jsp?user_name=${user.user_name}">转会</a>&ndash;%&gt;--%>
<%--                    </td>--%>
                </tr>
